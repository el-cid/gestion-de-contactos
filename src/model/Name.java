...
public class Name{
    ...
    public Name (String givenName,String familyName, String additionalName,
            String honorificPreffix, String honorificSuffix){
        this.givenName=givenName;
        this.familyName=familyName;
        this.additionalName=additionalName;
        this.honorificPreffix=honorificPreffix;
